...
class Exp(BaseExp):
    def __init__(self):
        ...
        self.train_ann = "coco_format_train.json"
        self.val_ann = "coco_format_valid.json"
    ...
    def get_data_valloader(self, batch_size):
        from datasets import COCO24PDataset_val, TrainTransform
        
        self.dataset = COCO24PDataset_val(
                        img_size=(640, 640),
                        preproc=TrainTransform(max_labels=50,
                            flip_prob=0.0)
                        )
