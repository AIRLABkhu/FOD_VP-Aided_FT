...
class COCO24PDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, img_size=(640, 640), preproc=None):
        ...
        self.data_dir = "/media/airlab-jmw/DATA/Dataset/wood_train/images"
        self.label_dir = "/media/airlab-jmw/DATA/Dataset/wood_train/annotations"
    ...
    def load_label_from_txt(self):
        ...
        with warnings.catch_warnings():
            ...
            for label in label_files:
                ...
                image_list.append(label.replace("txt", "png"))
...
class COCO24PDataset_val(torch.utils.data.Dataset):
    """
    COCO 24P dataset class.
    """
    ...
    def __init__(self, img_size=(640, 640), preproc=None):
        ...
        self.data_dir = "/media/airlab-jmw/DATA/Dataset/wood_valid/images"
        self.label_dir = "/media/airlab-jmw/DATA/Dataset/wood_valid/annotations"
        # self.data_dir = "/home/airlab-jmw/Dataset/coco2017/images/val2017"
        # self.label_dir = "/home/airlab-jmw/Dataset/coco2017/labels/val2017_24XY_50"
        self.coco24p_dict, self.image_list = self.load_label_from_txt()
        self.item_numb = len(self.coco24p_dict)
        self.imgs = None
        self.resize_info = None
